...
<div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title mb-0">
            Proses <?php $role_name = $this->session->userdata('role_name'); //echo $role_name;?> Edit Data Pegawai
        </h5>
    ...
    <div class="modal-body" style="width:100%;">
        <form id="form-ubah">
            <div class="row">
            <input type="hidden" name="id_srp" id="id_srp" value="<?= $srp['id_srp'] ?>" class="form-control" autocomplete="off">
            <div class="col-sm-12">
                    <div class="form-group">
                        <label for="judul_skripsi">Nama</label>
                        <input type="text" name="nama" id="nama"  value="<?= $srp['nama'] ?>" class="form-control" autocomplete="off" required>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="number" name="usia" id="usia" value="<?= $srp['usia'] ?>" class="form-control" autocomplete="off" required>
                        <small class="text-danger nama_instansi"></small>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="jk" id="pegawai" class="form-control select2" style="width: 100%;">
                            <?php //foreach ($result_pegawai as $pegawai) : ?>
                                <option value="<?= $srp['jk'] ?>" selected><?= $srp['jk'] ?></option>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <select name="pg" id="pegawai" class="form-control select2" style="width: 100%;">
                            <?php //foreach ($result_pegawai as $pegawai) : ?>
                                <option value="<?php echo  "$srp[golongan]-$srp[tingkat_golongan] -$srp[pangkat] "; ?>" selected><?php echo  "$srp[golongan] $srp[tingkat_golongan]  $srp[pangkat] "; ?></option>
    ...
    <?php
     ...
     {
        $name_button = "btn-ubah";
     }
    ?>
    <div class="modal-footer">
        <button type="button" id="<?=$name_button;?>" class="btn btn-sm btn-primary">
