...
<head>
    ...
    <title>BKD MEDAN - TASK</title>
    <meta name="description" content="Aplikasi Pengajuan Surat Teknik Kimia USU" />
    <meta name="keywords" content="Aplikasi Pengajuan Surat Teknik Kimia USU" />
    <meta name="author" content="Aplikasi Pengajuan Surat Teknik Kimia USU" />
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url('images/logo.ico'); ?>">
    <style>
        #load {
            width: 100%;
            height: 100%;
...
<body>
    <div class="page login-page">
        ...
        <div class="container d-flex align-items-center">
            <div class="form-holder" style="border-radius:25px;">
                <div class="row has-shadow">
                    <div class="col-lg-6">
                        <div class="info d-flex align-items-center">
                            <div class="content">
                                <h2 class="text-center mb-3" style="font-size: 2em;">BKD MEDAN TASK</h2>
                                <div class="logo" style="text-align: center;">
                                    <img src="<?= base_url('images/logo.png'); ?>" class="img-fluid img-logo" width="175px">
                                </div>
                                <br>
                                <h2 class="text-center" style="font-size: 1em; font-weight: bold;">BKD MEDAN</h2>
                            </div>
                        </div>
                    </div>
                ...
                <div class="text-center" style="color: white; margin-top: 15px;">
                    <strong style="color:#0f6095;">Copyright &copy; <?= "2021"; ?> BKD MEDAN</strong>
                </div>
            </div>
        </div>
    </div>
