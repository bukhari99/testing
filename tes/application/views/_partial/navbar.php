<div class="main-header">
    ...
    <div class="logo-header" data-background-color="blue">
        <a href="<?= site_url("dashboard"); ?>" class="logo">
            <img src="<?= base_url('images/logo.ico'); ?>" alt="Icon" style="width: 25px; margin-right: 5px;">
            <h3 class="navbar-brand text-white" style="font-size: 18px; font-weight: bold;">BKD</h3>
        </a>
